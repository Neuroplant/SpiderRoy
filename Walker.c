...
// Modul: 128
 ...
 Servo[0].pin = 17 + PIN_BASE1; 
 Servo[0].min = 11; 
 Servo[0].max = 26; 

 Servo[1].pin = 18 + PIN_BASE1; 
 Servo[1].min = 5; 
 Servo[1].max = 19; 

 Servo[3].pin = 20 + PIN_BASE1; 
 Servo[3].min = 21; 
 Servo[3].max = 7; 

 Servo[4].pin = 21 + PIN_BASE1; 
 Servo[4].min = 27; 
 Servo[4].max = 5; 

 Servo[5].pin = 22 + PIN_BASE1; 
 Servo[5].min = 5; 
 Servo[5].max = 27; 

 Servo[9].pin = 23 + PIN_BASE1; 
 Servo[9].min = 22; 
 Servo[9].max = 7; 

 Servo[10].pin = 24 + PIN_BASE1; 
 Servo[10].min = 27; 
 Servo[10].max = 5; 

 Servo[11].pin = 25 + PIN_BASE1; 
 Servo[11].min = 5; 
 Servo[11].max = 27; 

 Servo[15].pin = 26 + PIN_BASE1; 
 Servo[15].min = 26; 
 Servo[15].max = 8; 

 Servo[16].pin = 27 + PIN_BASE1; 
 Servo[16].min = 27; 
 Servo[16].max = 5; 

 Servo[17].pin = 28 + PIN_BASE1; 
 Servo[17].min = 5; 
 Servo[17].max = 27; 

 Servo[0].pin = 33 + PIN_BASE1; 
 Servo[0].min = 0; 
 Servo[0].max = 0; 
